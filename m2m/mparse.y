/*
  ...
  versione 1.13b17 del 30 luglio 2020
...
| ':' testo {
  $$.testo = makeTesto($1.ln, ':', NULL, NULL, $2.testo);
}
| ADKEY testo {
...
/*
  testopar: LEFTPAR testo RIGHTPAR {
  if ($3.ln - $1.ln > 20) {
  yymessage($1.ln,"tonda aperta");
  yymessage($3.ln,"chiusa in questo punto");
  }
  $$.testo = $2.testo;
  }
  | LEFTPAR error {
  $$.testo = NULL;
  yymessage($1.ln, "dopo questo punto");
  yyerrok;
  }
*/
...
/*
  lemma: LEMMAKEY option listatestibra {
  if ($2.lexema) {
...
| DESCOMPLKEY testobra testobra testobra {
...
figskip: FIGSKIPKEY opttestosquare testobra {
  $$.testo = makeTesto($1.ln, NOKEY, NULL, $2.testo, $3.testo);
};

figura: FIGURAKEY opttestosquare testobra {
  $$.testo = makeTesto($1.ln, NOKEY, NULL, $2.testo, $3.testo);
};
