...
m2xml: traduttore da M-TeX a XML basato mvisit
...
// FUNZIONI SPECIFICHE DEL TRADUTTORE
	...
	if (parametri->label == NULL || parametri->nota)
	{
		...
		case DOCENVKEY:
			if (inizio)
			{
				...
				fprintf(parametri->outFile,
						"<edition>");
				fprintf(parametri->outFile, "<header>");
				fprintf(parametri->outFile, "<title content=\"\"/>");
				fprintf(parametri->outFile, "</header>");
		...
		case SOTTOCAPITOLOKEY:
			...
			{
				fprintf(parametri->outFile, "</sottocapitolo>\n");
			}
			break;
		case TEOREMAKEY:
			if (inizio)
		...
		case NBSPACEKEY:
			if (inizio)
			{
				fprintf(parametri->outFile, "<nbsp />");
			}
			break;
		case FLATKEY:
			if (inizio)
...
void printFig(short key, struct testo *testo, PARAMETRI *parametri)
{
	...
	{
		// DIDASCALIA
		fprintf(parametri->outFile, "<caption>");
		...
		if (parametri->label == NULL || parametri->nota)
		{
			...
			case MACRO:
				if (strcmp(lexema, "\\ss") == 0)
					fprintf(parametri->outFile, "&szlig;");
				if (strcmp(lexema, "\\ae") == 0)
					fprintf(parametri->outFile, "ae");
				if (strcmp(lexema, "\\oe") == 0)
					fprintf(parametri->outFile, "&#339;");
				if (strcmp(lexema, "\\OE") == 0)
					fprintf(parametri->outFile, "&#338;");
				if (strcmp(lexema, "\\AE") == 0)
					fprintf(parametri->outFile, "AE");
				if (strcmp(lexema, "\\c e") == 0)
					fprintf(parametri->outFile, "e(ced)");
				if (strcmp(lexema, "\\c p") == 0)
					fprintf(parametri->outFile, "<strike>p</strike>");
				if (strcmp(lexema, "\\c c") == 0)
					fprintf(parametri->outFile, "&ccedil;");
				if (strcmp(lexema, "\\c C") == 0)
					fprintf(parametri->outFile, "&Ccedil;");
				if (strcmp(lexema, "\\&") == 0)
					fprintf(parametri->outFile, "&amp;");
				if (strcmp(lexema, "\\it\\&") == 0)
					fprintf(parametri->outFile, "<emph><b>&amp;</b></emph>");
				if (strcmp(lexema, "\\.o") == 0)
					fprintf(parametri->outFile, "<strike>o</strike>");
				if (strcmp(lexema, "\\v o") == 0)
					fprintf(parametri->outFile, "<strike>o</strike>");
				if (strcmp(lexema, "\\Alpha") == 0)
					fprintf(parametri->outFile, "\\Alpha;");
				if (strcmp(lexema, "\\Beta") == 0)
					fprintf(parametri->outFile, "\\Beta;");
				if (strcmp(lexema, "\\Gamma") == 0)
					fprintf(parametri->outFile, "\\Gamma;");
				if (strcmp(lexema, "\\Delta") == 0)
					fprintf(parametri->outFile, "\\Delta;");
				if (strcmp(lexema, "\\Epsilon") == 0)
					fprintf(parametri->outFile, "\\Epsilon;");
				if (strcmp(lexema, "\\Zeta") == 0)
					fprintf(parametri->outFile, "\\Zeta;");
				if (strcmp(lexema, "\\Eta") == 0)
					fprintf(parametri->outFile, "\\Eta;");
				if (strcmp(lexema, "\\Theta") == 0)
					fprintf(parametri->outFile, "\\Theta;");
				if (strcmp(lexema, "\\Iota") == 0)
					fprintf(parametri->outFile, "\\Iota;");
				if (strcmp(lexema, "\\Kappa") == 0)
					fprintf(parametri->outFile, "\\Kappa;");
				if (strcmp(lexema, "\\Lambda") == 0)
					fprintf(parametri->outFile, "\\Lambda;");
				if (strcmp(lexema, "\\Mu") == 0)
					fprintf(parametri->outFile, "\\Mu;");
				if (strcmp(lexema, "\\Nu") == 0)
					fprintf(parametri->outFile, "\\Nu;");
				if (strcmp(lexema, "\\Xi") == 0)
					fprintf(parametri->outFile, "\\Xi;");
				if (strcmp(lexema, "\\Omicron") == 0)
					fprintf(parametri->outFile, "\\Omicron;");
				if (strcmp(lexema, "\\Pi") == 0)
					fprintf(parametri->outFile, "\\Pi;");
				if (strcmp(lexema, "\\Rho") == 0)
					fprintf(parametri->outFile, "\\Rho;");
				if (strcmp(lexema, "\\Sigma") == 0)
					fprintf(parametri->outFile, "\\Sigma;");
				if (strcmp(lexema, "\\Tau") == 0)
					fprintf(parametri->outFile, "\\Tau;");
				if (strcmp(lexema, "\\Upsilon") == 0)
					fprintf(parametri->outFile, "\\Upsilon;");
				if (strcmp(lexema, "\\Phi") == 0)
					fprintf(parametri->outFile, "\\Phi;");
				if (strcmp(lexema, "\\Chi") == 0)
					fprintf(parametri->outFile, "\\Chi;");
				if (strcmp(lexema, "\\Psi") == 0)
					fprintf(parametri->outFile, "\\Psi;");
				if (strcmp(lexema, "\\Omega") == 0)
					fprintf(parametri->outFile, "\\Omega;");
				if (strcmp(lexema, "\\alpha") == 0)
					fprintf(parametri->outFile, "\\alpha;");
				if (strcmp(lexema, "\\beta") == 0)
					fprintf(parametri->outFile, "\\beta;");
				...
				if (strcmp(lexema, "\\varepsilon") == 0)
					fprintf(parametri->outFile, "\\varepsilon;");
				if (strcmp(lexema, "\\epsilon") == 0)
					fprintf(parametri->outFile, "\\epsilon;");
				if (strcmp(lexema, "\\zeta") == 0)
					fprintf(parametri->outFile, "\\zeta;");
				...
				if (strcmp(lexema, "\\theta") == 0)
					fprintf(parametri->outFile, "\\theta;");
				if (strcmp(lexema, "\\iota") == 0)
					fprintf(parametri->outFile, "\\iota;");
				if (strcmp(lexema, "\\kappa") == 0)
					fprintf(parametri->outFile, "\\kappa;");
				...
				if (strcmp(lexema, "\\varsigma") == 0)
					fprintf(parametri->outFile, "\\sigmaf;");
				if (strcmp(lexema, "\\sigma") == 0)
					fprintf(parametri->outFile, "\\sigma;");
				if (strcmp(lexema, "\\tau") == 0)
					fprintf(parametri->outFile, "\\tau;");
				if (strcmp(lexema, "\\upsilon") == 0)
					fprintf(parametri->outFile, "\\upsilon;");
				if (strcmp(lexema, "\\varphi") == 0)
					fprintf(parametri->outFile, "\\varphi;");
				if (strcmp(lexema, "\\phi") == 0)
					fprintf(parametri->outFile, "\\phi;");
				if (strcmp(lexema, "\\chi") == 0)
					fprintf(parametri->outFile, "\\chi;");
...
void stampaSigle(struct testo *testo, PARAMETRIm2xml *parametri)
{
	...
	// STAMPO LE SIGLE FINCHE' CI SONO
	fprintf(parametri->outFile, "<ids>\n");
	while (testo != NULL)
	{
		// if (testo->lexema == NULL || strcmp(testo->lexema, "*") == 0) {
		fprintf(parametri->outFile, "<id id=\"%s\" />\n",
				...
				struct testo *sigle)
{
		...
		(testimoni->lexema == NULL || strcmp(testimoni->lexema, "*") != 0))
	{
		...
		fprintf(parametri->outFile, "<description>\n");

		// STAMPO LE SIGLE DEI TESTIMONI
		stampaSigle(testimoni, parametri);

		// STAMPO I DESCRIPTIONITEM
		while (n != NULL)
		{
			if (n->testo1)
			{
				...
				{
				case CRKEY:
					// fprintf(parametri->outFile, "<cr label=\"%s\" />\n", n->testo1->lexema);
					break;
				case ANTEDELKEY:
					// fprintf(parametri->outFile, "<antedel>");
					fprintf(parametri->outFile, "<descriptionitem><ontologyreference id=\"Descriptio\">ante</ontologyreference></descriptionitem><descriptionitem><readingreference /></descriptionitem><descriptionitem><ontologyreference id=\"Delevit\">");
					visitTesto(n->testo1, parametri, sigle);
					fprintf(parametri->outFile, "</ontologyreference></descriptionitem>");
					// fprintf(parametri->outFile, "</antedel>\n");
					break;
				case POSTDELKEY:
					// fprintf(parametri->outFile, "<postdel>");
					fprintf(parametri->outFile, "<descriptionitem><ontologyreference id=\"Descriptio\">post</ontologyreference></descriptionitem><descriptionitem><readingreference /></descriptionitem><descriptionitem><ontologyreference id=\"Delevit\">");
					visitTesto(n->testo1, parametri, sigle);
					fprintf(parametri->outFile, "</ontologyreference></descriptionitem>");
					...
					break;
				case LECKEY:
					// fprintf(parametri->outFile, "<lec>");
					visitTesto(n->testo1, parametri, sigle);
					// fprintf(parametri->outFile, "</lec>\n");
					break;
				case TRKEY:
					fprintf(parametri->outFile, "<descriptionitem><ontologyreference id=\"Descriptio\">");
					visitTesto(n->testo1, parametri, sigle);
					fprintf(parametri->outFile, "</ontologyreference></descriptionitem>");
					// fprintf(parametri->outFile, "<des>");
					// visitTesto(n->testo1, parametri, sigle);
					...
					break;
				case EDKEY:
					fprintf(parametri->outFile, "<descriptionitem><ontologyreference id=\"ED");
					visitTesto(n->testo1, parametri, sigle);
					fprintf(parametri->outFile, "\" /></descriptionitem>");
					// fprintf(parametri->outFile, "<ed>");
					// visitTesto(n->testo1, parametri, sigle);
					// fprintf(parametri->outFile, "</ed>\n");
					break;
				case POSTSCRIPTKEY:
				...
				case BISKEY:
					...
					break;
				case INTERLKEY:
					// fprintf(parametri->outFile, "<interl />\n");
					fprintf(parametri->outFile,
							"<descriptionitem><ontologyreference id=\"SupraLineam\"/></descriptionitem>\n");
					break;
				case SUPRAKEY:
					fprintf(parametri->outFile,
							"<descriptionitem><ontologyreference id=\"SupraLineam\"/></descriptionitem>\n");
					// fprintf(parametri->outFile, "<supra />\n");
					break;
				case MARGKEY:
					fprintf(parametri->outFile,
							"<descriptionitem><ontologyreference id=\"InMargine\"/></descriptionitem>\n");
					// fprintf(parametri->outFile, "<marg />\n");
					break;
				case MARGSIGNKEY:
					fprintf(parametri->outFile,
							"<descriptionitem><ontologyreference id=\"SignoPositoInMargine\"/></descriptionitem>\n");
					// fprintf(parametri->outFile, "<margsign />\n");
					break;
				case PCKEY:
					// fprintf(parametri->outFile, "<pc />\n");
					fprintf(parametri->outFile,
							"<descriptionitem><ontologyreference id=\"PostCorrectionem\"/></descriptionitem>\n");
					break;
				case EXKEY:
					// fprintf(parametri->outFile, "<ex>");
					// visitTesto(n->testo1, parametri, sigle);
					// fprintf(parametri->outFile, "</ex>\n");
					fprintf(parametri->outFile,
							"<descriptionitem><ontologyreference id=\"CorrexitEx\" /></descriptionitem>\n");
					fprintf(parametri->outFile,
							"<descriptionitem><reading><content>");
					visitTesto(n->testo1, parametri, sigle);
					fprintf(parametri->outFile, "</content></reading></descriptionitem>\n");
					break;
				case REPKEY:
					fprintf(parametri->outFile, "<rep  num=\"%s\" />\n", n->testo1->lexema);
					break;

				case DESCOMPLKEY:
					/*
					  fprintf(parametri->outFile, "<descompl>");
					  fprintf(parametri->outFile, "<des1>");
					  visitTesto(n->testo1->testo1->testo1, parametri, sigle);
					  fprintf(parametri->outFile, "</des1>");
					  fprintf(parametri->outFile, "<des2>");
					...
					*/
					fprintf(parametri->outFile, "<descriptionitem>");
					fprintf(parametri->outFile, "<ontologyreference id=\"Descriptio\">");
					visitTesto(n->testo1->testo1->testo1, parametri, sigle);
					fprintf(parametri->outFile, "</ontologyreference>");
					fprintf(parametri->outFile, "</descriptionitem>");

					fprintf(parametri->outFile, "<descriptionitem>");
					fprintf(parametri->outFile, "<readingreference />");
					fprintf(parametri->outFile, "</descriptionitem>");
					...
					break;
				case EDCOMPLKEY:
					fprintf(parametri->outFile, "<edcompl>");
					fprintf(parametri->outFile, "<des1>");
					visitTesto(n->testo1->testo1->testo1, parametri, sigle);
					fprintf(parametri->outFile, "</des1>");
					fprintf(parametri->outFile, "<des2>");
				...
				default:
					fprintf(parametri->outFile, "<unknown />\n");
					break;
				}
			}
			n = n->testo2;
