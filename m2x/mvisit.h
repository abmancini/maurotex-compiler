...
// FUNZIONE DI STAMPA DI UNA FRAZIONE MULTIPLA
...
void printAdnotatio(const char *label, struct testo *testo, PARAMETRI *parametri, struct testo *sigle);
...
// FUNZIONE PER OPZIONE LEZIONE VARIANTE PRECEDENTE SE ATTUALE VUOTA
