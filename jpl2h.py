...
def maketitle(s,ismaketitle):
	...
	t=''
	if title != None:
		t=t+'<center><h1><!-- titre -->'+title+'<!-- /titre --></h1></center>\n\n'
	else:
		title=''
	if ismaketitle==1:
		if author != None:
			t=t+'<center><h2><!-- auteur -->'+author+'<!-- /auteur --></h2></center>\n\n'
		
		if date != None and date != '':
			t=t+'<center><h3><!-- date -->'+date+'<!-- /date --></h3></center>\n\n'
		elif date == None:
			t=t+'<center><h3><!-- date -->'+time.strftime("%d-%m-%Y",time.localtime(time.time()))+'<!-- /date --></h3></center>\n\n'
